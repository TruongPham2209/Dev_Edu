...
export type ExtendedPostResponse = PostResponse & {
  tags?: string[];
  status?: PostStatus;
};
...
export function PostCard({
  ...
  tab?: "posted" | "saved";
  onEdit?: (post: ExtendedPostResponse) => void;
  onHistory?: (post: ExtendedPostResponse) => void;
  onRemove?: (post: ExtendedPostResponse) => void;
  onUnsave?: (post: ExtendedPostResponse) => void;
}) {
  ...
  const tags = post.tags || ["Thảo luận"];
