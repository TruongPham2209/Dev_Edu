...
public interface NotificationService {
    ...
    /**
     * Gets unified notification feed for a user (combining personal and group notifications via UNION ALL).
     */
    CustomPaging<NotificationResponse> getUnifiedNotifications(String username, Collection<String> userRoles, String cursor);
