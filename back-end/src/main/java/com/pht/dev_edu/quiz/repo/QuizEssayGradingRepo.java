...
public interface QuizEssayGradingRepo extends JpaRepository<QuizEssayGradingEntity, UUID> {
    List<QuizEssayGradingEntity> findByAttemptAnswerIdOrderByGradedAtDesc(UUID attemptAnswerId);

    List<QuizEssayGradingEntity> findByAttemptIdOrderByGradedAtDesc(UUID attemptId);
}
