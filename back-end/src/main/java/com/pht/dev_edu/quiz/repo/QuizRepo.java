...
public interface QuizRepo extends JpaRepository<QuizEntity, UUID> {
        @Query(value = """
                        ...
                        LIMIT :limit
                        """, nativeQuery = true)
        List<QuizEntity> findByCourseIdAndDeletedAtIsNull(UUID courseId, String status, UUID lastId,
        ...
        @Query(value = """
                        ...
                        LIMIT :limit
                        """, nativeQuery = true)
        List<QuizEntity> findByStatusAndDeletedAtIsNull(String status, UUID lastId, LocalDateTime lastTimestamp,
                        int limit);
}
